...
class MotionTracker:
    ...
    def process_frame(self, diff_frame, video_frame, current_time):
        ...
        n_largest_rois = 1  # Change this value to consider more or fewer top ROIs
        ...
        for roi, azimuth, velocity, direction, roi_time in self.decay_info:
            ...
            lead_time = 5  # Change this value to adjust the distance between the yellow and green dots
